!(function (e, t) {
  ...
  function g(e, t, n) {
    ...
    if (((i.text = e), t))
      for (r in we) (a = t[r] || (t.getAttribute && t.getAttribute(r))) && i.setAttribute(r, a);
  ...
  function a() {
    xe.removeEventListener("DOMContentLoaded", a), le.removeEventListener("load", a), De.ready();
  }
  function i(e, t) {
  ...
  function u(e) {
    return (
      "true" === e ||
      ("false" !== e && ("null" === e ? null : e === +e + "" ? +e : Ye.test(e) ? JSON.parse(e) : e))
    );
  }
  function p(e, t, n) {
    var r;
  ...
  function v(e, t, n, r) {
    var a,
      ...
      c = e.nodeType && (De.cssNumber[t] || ("px" !== u && +l)) && Qe.exec(De.css(e, t));
    if (c && c[3] !== u) {
      for (l /= 2, u = u || c[3], c = +l || 1; o--; )
        De.style(e, t, c + u), (1 - i) * (1 - (i = s() / l || 0.5)) <= 0 && (o = 0), (c /= i);
  ...
  function b(e, t) {
    for (var n, r, a = [], i = 0, o = e.length; i < o; i++)
      (r = e[i]).style &&
        ...
        t
          ? ("none" === n &&
              ((a[i] = Ge.get(r, "display") || null), a[i] || (r.style.display = "")),
  ...
  function S(e, t, n, r, a) {
    for (
      var i, o, s, l, u, c, f = t.createDocumentFragment(), d = [], h = 0, p = e.length;
      h < p;
      h++
    )
      if ((i = e[h]) || 0 === i)
  ...
  function C(e, t, n, r, a, i) {
    ...
    if (
      (null == r && null == a
        ? ((a = n), (r = n = undefined))
        : null == a &&
          ("string" == typeof n ? ((a = r), (r = undefined)) : ((a = r), (r = n), (n = undefined))),
      !1 === a)
    )
      a = D;
    else if (!a) return e;
        ...
        De.event.add(e, r, {
          ...
          handler: function (e) {
            ...
            if (1 & e.isTrigger && this[r]) {
              if (n) (De.event.special[r] || {}).delegateType && e.stopPropagation();
              else if (
                ((n = fe.call(arguments)),
                Ge.set(this, r, n),
                this[r](),
  ...
  function j(e, t) {
    ...
    if (1 === t.nodeType) {
      ...
      Je.hasData(e) && ((i = Je.access(e)), (o = De.extend({}, i)), Je.set(t, o));
    }
  }
  function I(e, t) {
  ...
  function L(n, r, a, i) {
    ...
    if (
      ...
      for (s = (o = De.map(x(e, "script"), k)).length; c < f; c++)
        (l = e),
          c !== d && ((l = De.clone(l, !0, !0)), s && De.merge(o, x(l, "script"))),
          a.call(n[c], l, c);
      if (s)
          ...
          (l = o[c]),
            ct.test(l.type || "") &&
              ...
              (l.src && "module" !== (l.type || "").toLowerCase()
                ? De._evalUrl &&
                  !l.noModule &&
                  De._evalUrl(l.src, { nonce: l.nonce || l.getAttribute("nonce") }, u)
  ...
  function E(e, t, n) {
    for (var r, a = t ? De.filter(t, e) : e, i = 0; null != (r = a[i]); i++)
      n || 1 !== r.nodeType || De.cleanData(x(r)),
        r.parentNode && (n && nt(r) && w(x(r, "script")), r.parentNode.removeChild(r));
    return e;
  }
  function R(e, t, n) {
    var r,
  ...
  function O(e, t, n, r, a, i) {
      ...
      "margin" === n && (u += De.css(e, n + et[o], !0, a)),
        r
          ? ("content" === n && (l -= De.css(e, "padding" + et[o], !0, a)),
            "margin" !== n && (l -= De.css(e, "border" + et[o] + "Width", !0, a)))
    ...
    return (
      !r &&
        0 <= i &&
        (l +=
          Math.max(0, Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - i - l - s - 0.5)) ||
          0),
      l + u
    );
  }
  function q(e, t, n) {
    var r = bt(e),
      a = (!ve.boxSizingReliable() || n) && "border-box" === De.css(e, "boxSizing", !1, r),
      i = a,
      o = R(e, t, r),
    ...
    return (
      ((!ve.boxSizingReliable() && a) ||
        ...
        ((a = "border-box" === De.css(e, "boxSizing", !1, r)), (i = s in e) && (o = e[s])),
      (o = parseFloat(o) || 0) + O(e, t, n || (a ? "border" : "content"), i, r, o) + "px"
    );
  }
  ...
  function U(e, t) {
    var n,
      r = 0,
      a = { height: e };
    for (t = t ? 1 : 0; r < 4; r += 2 - t) a["margin" + (n = et[r])] = a["padding" + n] = e;
    return t && (a.opacity = a.width = e), a;
  }
  function z(e, t, n) {
    for (var r, a = (G.tweeners[t] || []).concat(G.tweeners["*"]), i = 0, o = a.length; i < o; i++)
  ...
  function X(e, t, n) {
    ...
    t))
      if (((a = t[r]), Lt.test(a))) {
        if ((delete t[r], (i = i || "toggle" === a), a === (g ? "hide" : "show"))) {
    ...
    if ((l = !De.isEmptyObject(t)) || !De.isEmptyObject(h))
      for (r in (f &&
        ...
        "none" === (c = De.css(e, "display")) &&
          (u
            ? (c = u)
            : (b([e], !0), (u = e.style.display || u), (c = De.css(e, "display")), b([e]))),
      ...
      h))
        l ||
          (m ? "hidden" in m && (g = m.hidden) : (m = Ge.access(e, "fxshow", { display: u })),
          i && (m.hidden = !g),
          g && b([e], !0),
          d.done(function () {
            for (r in (g || b([e]), Ge.remove(e, "fxshow"), h)) De.style(e, r, h[r]);
          })),
          (l = z(g ? m[r] : 0, r, d)),
  ...
  function G(i, e, t) {
    var n,
      ...
      l = function () {
        ...
        return (
          ...
          n < 1 && a ? t : (a || s.notifyWith(i, [u, 1, 0]), s.resolveWith(i, [u]), !1)
        );
      },
      u = s.promise({
        elem: i,
        props: De.extend({}, e),
        opts: De.extend(!0, { specialEasing: {}, easing: De.easing._default }, t),
        ...
        stop: function (e) {
          ...
          return (
            e ? (s.notifyWith(i, [u, 1, 0]), s.resolveWith(i, [u, e])) : s.rejectWith(i, [u, e]),
            this
          );
        },
      }),
    ...
    for (V(c, u.opts.specialEasing); r < a; r++)
      if ((n = G.prefilters[r].call(u, i, c, u.opts)))
        return ye(n.stop) && (De._queueHooks(u.elem, u.opts.queue).stop = n.stop.bind(n)), n;
    return (
      De.map(c, z, u),
  ...
  function K(n, e, r, a) {
    ...
    if (Array.isArray(e))
      De.each(e, function (e, t) {
        r || Ut.test(n)
          ? a(n, t)
          : K(n + "[" + ("object" == typeof t && null != t ? e : "") + "]", t, r, a);
      });
  ...
  function ne(e, t, n) {
    for (var r, a, i, o, s = e.contents, l = e.dataTypes; "*" === l[0]; )
      l.shift(), r === undefined && (r = e.mimeType || t.getResponseHeader("Content-Type"));
    if (r)
      for (a in s)
        if (s[a] && s[a].test(r)) {
          l.unshift(a);
  ...
  (De.fn = De.prototype = {
    ...
    (De.extend = De.fn.extend = function (e) {
      var t,
        n,
        r,
        a,
            ...
            (a = t[n]),
              "__proto__" !== n &&
                ...
                (c && a && (De.isPlainObject(a) || (i = Array.isArray(a)))
                  ? ((r = s[n]),
                    (o = i && !Array.isArray(r) ? [] : i || De.isPlainObject(r) ? r : {}),
                    (i = !1),
                    (s[n] = De.extend(c, o, a)))
                  : a !== undefined && (s[n] = a));
      return s;
    ...
    De.extend({
      ...
      isPlainObject: function (e) {
        ...
        return (
          ...
          (!(t = ae(e)) ||
            ("function" == typeof (n = pe.call(t, "constructor") && t.constructor) &&
              ge.call(n) === me))
        );
      },
      ...
      makeArray: function (e, t) {
        var n = t || [];
        return (
          null != e && (s(Object(e)) ? De.merge(n, "string" == typeof e ? [e] : e) : oe.call(n, e)),
          n
        );
      },
      ...
      map: function (e, t, n) {
        var r,
          ...
          i = 0,
          o = [];
        if (s(e)) for (r = e.length; i < r; i++) null != (a = t(e[i], i, n)) && o.push(a);
    ...
    "function" == typeof Symbol && (De.fn[Symbol.iterator] = ce[Symbol.iterator]),
    De.each(
  ...
  !(function () {
      ...
      if (!r && (x(t), (t = t || k), j)) {
        if (11 !== d && (l = te.exec(e)))
          if ((a = l[1])) {
            ...
            } else if (f && (o = f.getElementById(a)) && p.contains(t, o) && o.id === a)
              return E.call(n, o), n;
          } else {
    ...
    function e() {
      function n(e, t) {
        return r.push(e + " ") > D.cacheLength && delete n[r.shift()], (n[e + " "] = t);
      }
      var r = [];
      return n;
    }
    ...
    function m(e, t) {
      ...
      for (o = e, s = [], l = D.preFilter; o; ) {
        ...
        D.filter))
          !(r = K[i].exec(o)) ||
            (l[i] && !(r = l[i](r))) ||
            ((n = r.shift()), a.push({ value: n, type: i, matches: r }), (o = o.slice(n.length)));
        if (!n) break;
      }
      ...
      return e.first
        ...
        : function (e, t, n) {
            var r,
              ...
              i = [F, f];
            if (n) {
              for (; (e = e[s]); ) if ((1 === e.nodeType || c) && o(e, t, n)) return !0;
            } else
              for (; (e = e[s]); )
                if (1 === e.nodeType || c)
                  if (((a = e[R] || (e[R] = {})), l && ue(e, l))) e = e[s] || e;
                  else {
                    if ((r = a[u]) && r[0] === F && r[1] === f) return (i[2] = r[2]);
    ...
    function b(h, p, g, m, v, e) {
      return (
        ...
        n(function (e, t, n, r) {
          ...
          if ((g ? g(d, (s = v || (e ? h : c || m) ? [] : t), n, r) : (s = d), m))
            for (a = w(s, u), m(a, [], n, r), i = a.length; i--; )
              (o = a[i]) && (s[u[i]] = !(d[u[i]] = o));
          if (e) {
            if (v || h) {
              if (v) {
                for (a = [], i = s.length; i--; ) (o = s[i]) && a.push((d[i] = o));
                v(null, (s = []), a, r);
              }
              for (i = s.length; i--; )
                (o = s[i]) && -1 < (a = v ? de.call(e, o) : l[i]) && (e[a] = !(t[a] = o));
            }
          } else (s = w(s === t ? s.splice(c, s.length) : s)), v ? v(null, t, s, r) : E.apply(t, s);
        })
      );
    }
    function h(e) {
      for (
        var a,
          ...
          c = [
            function (e, t, n) {
              var r = (!i && (n || t != C)) || ((a = t).nodeType ? l(e, t, n) : u(e, t, n));
              return (a = null), r;
            },
          ];
        s < r;
        ...
        if ((t = D.relative[e[s].type])) c = [f(d(c), t)];
          ...
          if ((t = D.filter[e[s].type].apply(null, e[s].matches))[R]) {
            ...
            return b(
              1 < s && d(c),
              1 < s &&
                v(e.slice(0, s - 1).concat({ value: " " === e[s - 2].type ? "*" : "" })).replace(
                  Ne,
                  "$1"
                ),
              t,
      ...
      var y = 0 < v.length,
        ...
        e = function (e, t, n, r, a) {
          var i,
            ...
            g = h.length;
          for (a && (C = t == k || t || a); u !== g && null != (i = h[u]); u++) {
            if (b && i) {
              for (o = 0, t || i.ownerDocument == k || (x(i), (n = !j)); (s = m[o++]); )
                if (s(i, t || k, n)) {
                  E.call(r, i);
                  break;
                }
          ...
          if (((l += u), y && u !== l)) {
            ...
            E.apply(r, f), a && !e && 0 < f.length && 1 < l + v.length && De.uniqueSort(r);
          }
          return a && ((F = p), (C = d)), c;
        };
      return y ? n(e) : e;
    ...
    function S(e, t) {
      var n,
        ...
        i = O[e + " "];
      if (!i) {
        for (t || (t = m(e)), n = t.length; n--; ) (i = h(t[n]))[R] ? r.push(i) : a.push(i);
    ...
    function T(e, t, n, r) {
      ...
      if (((n = n || []), 1 === c.length)) {
        if (
          ...
          if (!(t = (D.find.ID(o.matches[0].replace(re, ae), t) || [])[0])) return n;
        ...
        for (
          ...
          if (
            (l = D.find[s]) &&
            (r = l(o.matches[0].replace(re, ae), (ne.test(i[0].type) && g(t.parentNode)) || t))
          ) {
            if ((i.splice(a, 1), !(e = r.length && v(i)))) return E.apply(n, r), n;
            break;
          }
      }
      return (u || S(e, c))(r, t, !j, n, !t || (ne.test(e) && g(t.parentNode)) || t), n;
    }
    var c,
      D,
      C,
    ...
    try {
      E.apply((ce = fe.call(Ie.childNodes)), Ie.childNodes), ce[Ie.childNodes.length].nodeType;
    } catch (se) {
      E = {
        apply: function (e, t) {
    ...
    (p.matchesSelector = function (e, t) {
      if ((x(e), j && !q[t + " "] && (!I || !I.test(t))))
        try {
          var n = L.call(e, t);
          if (n || ve.disconnectedMatch || (e.document && 11 !== e.document.nodeType)) return n;
        } catch (se) {
          q(t, !0);
        }
    ...
    (p.attr = function (e, t) {
      ...
      var n = D.attrHandle[t.toLowerCase()],
        r = n && pe.call(D.attrHandle, t.toLowerCase()) ? n(e, t, !j) : undefined;
    ...
    (De.uniqueSort = function (e) {
      var t,
        ...
        r = 0,
        a = 0;
      if (((A = !ve.sortStable), (_ = !ve.sortStable && fe.call(e, 0)), _e.call(e, W), A)) {
    ...
    ((D = De.expr = {
      ...
      filter: {
            ...
            return null == t
              ...
              : !r ||
                  ...
                  "=" === r
                    ...
                    : "~=" === r
                    ? -1 < (" " + t.replace(X, " ") + " ").indexOf(a)
                    : "|=" === r && (t === a || t.slice(0, a.length + 1) === a + "-"));
          };
        },
          ...
          return 1 === p && 0 === g
            ...
            : function (e, t, n) {
                ...
                if (u) {
                  if (m) {
                    for (; l; ) {
                      for (i = e; (i = i[l]); ) if (y ? ue(i, c) : 1 === i.nodeType) return !1;
        ...
        PSEUDO: function (e, i) {
          var t,
            o =
              D.pseudos[e] || D.setFilters[e.toLowerCase()] || p.error("unsupported pseudo: " + e);
          return o[R]
            ? o(i)
            : 1 < o.length
            ? ((t = [e, e, "", i]),
      ...
      pseudos: {
        ...
        focus: function (e) {
          return e === t() && k.hasFocus() && !!(e.type || e.href || ~e.tabIndex);
        },
        enabled: o(!1),
        disabled: o(!0),
        checked: function (e) {
          return (ue(e, "input") && !!e.checked) || (ue(e, "option") && !!e.selected);
        },
        selected: function (e) {
  ...
  (De.filter = function (e, t, n) {
    ...
    De.fn.extend({
      ...
      is: function (e) {
        return !!n(this, "string" == typeof e && Fe.test(e) ? De(e) : e || [], !1).length;
      },
    });
  var He,
    Me = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
  ((De.fn.init = function (e, t, n) {
    ...
    if (
      !(r =
        "<" === e[0] && ">" === e[e.length - 1] && 3 <= e.length ? [null, e, null] : Me.exec(e)) ||
      (!r[1] && t)
    )
    ...
    if (r[1]) {
      if (
        ...
        De.merge(this, De.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : xe, !0)),
        Pe.test(r[1]) && De.isPlainObject(t))
      )
        for (r in t) ye(this[r]) ? this[r](t[r]) : this.attr(r, t[r]);
      return this;
    }
    return (a = xe.getElementById(r[2])) && ((this[0] = a), (this.length = 1)), this;
  }).prototype = De.fn),
    (He = De(xe));
      ...
      if (!Fe.test(e))
        for (; r < a; r++)
          for (n = this[r]; n && n !== t; n = n.parentNode)
            if (
              n.nodeType < 11 &&
              (o ? -1 < o.index(n) : 1 === n.nodeType && De.find.matchesSelector(n, e))
            ) {
              i.push(n);
              break;
            }
    ...
    De.each(
      {
        ...
        contents: function (e) {
          return null != e.contentDocument && ae(e.contentDocument)
            ? e.contentDocument
            : (ue(e, "template") && (e = e.content || e), De.merge([], e.childNodes));
        },
      },
      function (r, a) {
        De.fn[r] = function (e, t) {
          ...
          return (
            ...
            1 < this.length && (qe[r] || De.uniqueSort(n), Oe.test(r) && n.reverse()),
            this.pushStack(n)
          );
        };
      }
      ...
      l = function () {
        for (n = n || r.once, t = a = !0; o.length; s = -1)
          for (e = o.shift(); ++s < i.length; )
            !1 === i[s].apply(e[0], e[1]) && r.stopOnFalse && ((s = i.length), (e = !1));
        ...
        remove: function () {
          return (
            De.each(arguments, function (e, t) {
              for (var n; -1 < (n = De.inArray(t, i, n)); ) i.splice(n, 1), n <= s && s--;
            }),
            this
          );
        },
                        ...
                        (t = e && ("object" == typeof e || "function" == typeof e) && e.then),
                          ye(t)
                            ? l
                              ...
                              : (c++,
                                t.call(e, u(c, o, f, l), u(c, o, d, l), u(c, o, f, o.notifyWith)))
                            : (s !== f && ((n = undefined), (r = [e])), (l || o.resolveWith)(n, r));
                      }
                    },
                    a = l
                      ? t
                      : function () {
                          try {
                            ...
                            De.Deferred.exceptionHook && De.Deferred.exceptionHook(e, a.error),
                              c <= i + 1 &&
                                (s !== d && ((n = undefined), (r = [e])), o.rejectWith(n, r));
                          }
                        };
                  i
                    ? a()
                    : (De.Deferred.getErrorHook
                        ...
                        : De.Deferred.getStackHook && (a.error = De.Deferred.getStackHook()),
                      le.setTimeout(a));
                };
              }
              var c = 0;
  ...
  (De.fn.ready = function (e) {
    ...
    "complete" === xe.readyState || ("loading" !== xe.readyState && !xe.documentElement.doScroll)
      ? le.setTimeout(De.ready)
      : (xe.addEventListener("DOMContentLoaded", a), le.addEventListener("load", a));
  var Ue = function (e, t, n, r, a, i, o) {
      var s = 0,
        l = e.length,
        u = null == n;
      if ("object" === m(n)) for (s in ((a = !0), n)) Ue(e, t, s, n[s], !0, i, o);
      else if (
        r !== undefined &&
        ((a = !0),
        ye(r) || (o = !0),
  ...
  (o.uid = 1),
    (o.prototype = {
      ...
      remove: function (e, t) {
        ...
        if (r !== undefined) {
          if (t !== undefined) {
            n = (t = Array.isArray(t) ? t.map(h) : (t = h(t)) in r ? [t] : t.match(We) || [])
              .length;
            for (; n--; ) delete r[t[n]];
          }
  ...
  De.extend({
    ...
    De.fn.extend({
      data: function (n, e) {
        ...
        if (this.length && ((a = Je.get(i)), 1 === i.nodeType && !Ge.get(i, "hasDataAttrs"))) {
          for (t = o.length; t--; )
            o[t] && 0 === (r = o[t].name).indexOf("data-") && ((r = h(r.slice(5))), p(i, r, a[r]));
      ...
      queue: function (e, t, n) {
        ...
        if (e)
          return (
            (t = (t || "fx") + "queue"),
            (r = Ge.get(e, t)),
            n && (!r || Array.isArray(n) ? (r = Ge.access(e, t, De.makeArray(n))) : r.push(n)),
            r || []
          );
      },
    ...
    De.fn.extend({
      ...
      promise: function (e, t) {
        ...
        for ("string" != typeof e && ((t = e), (e = undefined)), e = e || "fx"; o--; )
          (n = Ge.get(i[o], e + "queueHooks")) && n.empty && (r++, n.empty.add(s));
  ...
  tt.getRootNode &&
    (nt = function (e) {
      return De.contains(e.ownerDocument, e) || e.getRootNode(rt) === e.ownerDocument;
    });
  var at = function (e, t) {
      return (
  ...
  (ft.tbody = ft.tfoot = ft.colgroup = ft.caption = ft.thead),
    (ft.th = ft.td),
    ve.option || (ft.optgroup = ft.option = [1, "<select multiple='multiple'>", "</select>"]);
  var dt = /<|&#?\w+;/,
    ht = /^([^.]*)(?:\.(.+)|)/;
  (De.event = {
    global: {},
    ...
    remove: function (e, t, n, r, a) {
      ...
      if (m && (l = m.events)) {
        for (u = (t = (t || "").match(We) || [""]).length; u--; )
          if (((h = g = (s = ht.exec(t[u]) || [])[1]), (p = (s[2] || "").split(".").sort()), h)) {
            for (
              f = De.event.special[h] || {},
        ...
        for (
          ...
          for (
            ...
            (l.rnamespace && !1 !== i.namespace && !l.rnamespace.test(i.namespace)) ||
              ((l.handleObj = i),
              (l.data = i.data),
              (r = ((De.event.special[i.origType] || {}).handle || i.handler).apply(a.elem, s)) !==
                undefined &&
                !1 === (l.result = r) &&
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          var t = this || e;
          return lt.test(t.type) && t.click && ue(t, "input") && _(t, "click", !0), !1;
        },
        trigger: function (e) {
          var t = this || e;
          return lt.test(t.type) && t.click && ue(t, "input") && _(t, "click"), !0;
        },
        _default: function (e) {
          var t = e.target;
          return (lt.test(t.type) && t.click && ue(t, "input") && Ge.get(t, "click")) || ue(t, "a");
        },
      },
      beforeunload: {
    ...
    De.each({ focus: "focusin", blur: "focusout" }, function (r, a) {
      ...
      (De.event.special[r] = {
        setup: function () {
          ...
          (e = Ge.get(this, a)) || this.addEventListener(a, i), Ge.set(this, a, (e || 0) + 1);
        },
        trigger: function () {
          return _(this, r), !0;
        },
        ...
        (De.event.special[a] = {
          setup: function () {
            var e = this.ownerDocument || this.document || this,
              ...
              n = Ge.get(t, a);
            n || (xe.documentMode ? this.addEventListener(a, i) : e.addEventListener(r, i, !0)),
              Ge.set(t, a, (n || 0) + 1);
          },
          teardown: function () {
            var e = this.ownerDocument || this.document || this,
            ...
            n
              ? Ge.set(t, a, n)
              : (xe.documentMode ? this.removeEventListener(a, i) : e.removeEventListener(r, i, !0),
                Ge.remove(t, a));
          },
        });
    }),
          ...
          handle: function (e) {
            ...
            return (
              (r && (r === n || De.contains(n, r))) ||
                ((e.type = a.origType), (t = a.handler.apply(this, arguments)), (e.type = i)),
              t
            );
          },
        };
  ...
  De.extend({
    ...
    clone: function (e, t, n) {
      var r,
        ...
        s = e.cloneNode(!0),
        l = nt(e);
      if (!(ve.noCloneChecked || (1 !== e.nodeType && 11 !== e.nodeType) || De.isXMLDoc(e)))
        for (o = x(s), r = 0, a = (i = x(e)).length; r < a; r++) I(i[r], o[r]);
      if (t)
        if (n) for (i = i || x(e), o = o || x(s), r = 0, a = i.length; r < a; r++) j(i[r], o[r]);
        else j(e, s);
      return 0 < (o = x(s, "script")).length && w(o, !l && x(e, "script")), s;
    },
    cleanData: function (e) {
      for (var t, n, r, a = De.event.special, i = 0; (n = e[i]) !== undefined; i++)
        if (Ve(n)) {
          if ((t = n[Ge.expando])) {
            if (t.events)
              for (r in t.events) a[r] ? De.event.remove(n, r) : De.removeEvent(n, r, t.handle);
        ...
        return Ue(
          ...
          function (e) {
            ...
            if (
              ...
              try {
                for (; n < r; n++)
                  1 === (t = this[n] || {}).nodeType && (De.cleanData(x(t, !1)), (t.innerHTML = e));
                t = 0;
              } catch (a) {}
            }
      ...
      replaceWith: function () {
        ...
        return L(
          ...
          function (e) {
            ...
            De.inArray(this, n) < 0 && (De.cleanData(x(this)), t && t.replaceChild(e, this));
          },
          n
        );
      },
      ...
      function (e, o) {
        De.fn[e] = function (e) {
          for (var t, n = [], r = De(e), a = r.length - 1, i = 0; i <= a; i++)
            (t = i === a ? this : this.clone(!0)), De(r[i])[o](t), oe.apply(n, t.get());
  ...
  De.extend({
    ...
    style: function (e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var a,
          ...
          l = yt.test(t),
          u = e.style;
        if ((l || (t = H(s)), (o = De.cssHooks[t] || De.cssHooks[s]), n === undefined))
          return o && "get" in o && (a = o.get(e, !1, r)) !== undefined ? a : u[t];
        "string" === (i = typeof n) &&
          (a = Qe.exec(n)) &&
          a[1] &&
          ((n = v(e, t, a)), (i = "number")),
          null != n &&
            n == n &&
            ("number" !== i || l || (n += (a && a[3]) || (De.cssNumber[s] ? "" : "px")),
    ...
    css: function (e, t, n, r) {
      ...
      return (
        yt.test(t) || (t = H(s)),
        (o = De.cssHooks[t] || De.cssHooks[s]) && "get" in o && (a = o.get(e, !0, n)),
        ...
        return Ue(
          ...
          function (e, t, n) {
            var r,
              ...
              o = 0;
            if (Array.isArray(t)) {
              for (r = bt(e), a = t.length; o < a; o++) i[t[o]] = De.css(e, t[o], !1, r);
              return i;
            }
    ...
    (W.propHooks = {
      _default: {
        ...
        set: function (e) {
          De.fx.step[e.prop]
            ? De.fx.step[e.prop](e)
            : 1 !== e.elem.nodeType || (!De.cssHooks[e.prop] && null == e.elem.style[H(e.prop)])
            ? (e.elem[e.prop] = e.now)
      ...
      attr: function (e, t, n) {
        ...
        if (3 !== i && 8 !== i && 2 !== i)
          return "undefined" == typeof e.getAttribute
            ...
            : ((1 === i && De.isXMLDoc(e)) ||
                (a =
                  De.attrHooks[t.toLowerCase()] || (De.expr.match.bool.test(t) ? Rt : undefined)),
              n !== undefined
                ? null === n
    ...
    De.each(De.expr.match.bool.source.match(/\w+/g), function (e, t) {
      ...
      Ft[t] = function (e, t, n) {
        var r,
          a,
          i = t.toLowerCase();
        return n || ((a = Ft[i]), (Ft[i] = r), (r = null != o(e, t, n) ? i : null), (Ft[i] = a)), r;
      };
    });
  ...
  De.fn.extend({
    ...
    De.extend({
      prop: function (e, t, n) {
        ...
        if (3 !== i && 8 !== i && 2 !== i)
          return (
            (1 === i && De.isXMLDoc(e)) || ((t = De.propFix[t] || t), (a = De.propHooks[t])),
            n !== undefined
              ? a && "set" in a && (r = a.set(e, n, t)) !== undefined
                ? r
                : (e[t] = n)
    ...
    De.fn.extend({
      addClass: function (t) {
        ...
        return ye(t)
          ...
          : (e = Z(t)).length
          ? this.each(function () {
              if (((r = Y(this)), (n = 1 === this.nodeType && " " + J(r) + " "))) {
            ...
            this.each(function () {
              if (s)
                for (i = De(this), a = 0; a < e.length; a++)
                  (r = e[a]), i.hasClass(r) ? i.removeClass(r) : i.addClass(r);
              else
                (t !== undefined && "boolean" !== o) ||
                  ...
                  this.setAttribute &&
                    this.setAttribute(
                      "class",
                      r || !1 === t ? "" : Ge.get(this, "__className__") || ""
                    ));
            }));
      },
      hasClass: function (e) {
        var t,
          ...
          r = 0;
        for (t = " " + e + " "; (n = this[r++]); )
          if (1 === n.nodeType && -1 < (" " + J(Y(n)) + " ").indexOf(t)) return !0;
        return !1;
      },
    });
  var Mt = /\r/g;
        ...
        ? ((a = ye(n)),
          this.each(function (e) {
            ...
            1 === this.nodeType &&
              ...
              ((r = De.valHooks[this.type] || De.valHooks[this.nodeName.toLowerCase()]) &&
                "set" in r &&
                r.set(this, t, "value") !== undefined) ||
                (this.value = t));
          }))
        : t
        ? (r = De.valHooks[t.type] || De.valHooks[t.nodeName.toLowerCase()]) &&
          "get" in r &&
    ...
    De.extend({
      valHooks: {
        ...
        select: {
          ...
          set: function (e, t) {
            for (var n, r, a = e.options, i = De.makeArray(t), o = a.length; o--; )
              ((r = a[o]).selected = -1 < De.inArray(De.valHooks.option.get(r), i)) && (n = !0);
    ...
    trigger: function (e, t, n, r) {
      ...
      if (
        ...
        3 !== n.nodeType &&
          ...
          (l = h.indexOf(":") < 0 && "on" + h),
          ((e = e[De.expando] ? e : new De.Event(h, "object" == typeof e && e)).isTrigger = r
            ? 2
            : 3),
          (e.namespace = p.join(".")),
        ...
        if (!r && !c.noBubble && !be(n)) {
          for (s = c.delegateType || h, $t.test(s + h) || (i = i.parentNode); i; i = i.parentNode)
            d.push(i), (o = i);
          o === (n.ownerDocument || xe) && d.push(o.defaultView || o.parentWindow || le);
        }
        for (a = 0; (i = d[a++]) && !e.isPropagationStopped(); )
          (f = i),
            (e.type = 1 < a ? s : c.bindType || h),
            (u = (Ge.get(i, "events") || Object.create(null))[e.type] && Ge.get(i, "handle")) &&
              u.apply(i, t),
            (u = l && i[l]) &&
              u.apply &&
              Ve(i) &&
              ((e.result = u.apply(i, t)), !1 === e.result && e.preventDefault());
        return (
          (e.type = h),
          r ||
      ...
      ajax: function (e, t) {
        function n(e, t, n, r) {
          ...
          p ||
            ...
            a
              ? (m.ifModified &&
                  ((l = S.getResponseHeader("Last-Modified")) && (De.lastModified[f] = l),
            ...
            x.fireWith(v, [S, u]),
            g && (y.trigger("ajaxComplete", [S, m]), --De.active || De.event.trigger("ajaxStop")));
        }
        ...
        var c,
          ...
          S = {
            ...
            setRequestHeader: function (e, t) {
              return (
                null == p && ((e = l[e.toLowerCase()] = l[e.toLowerCase()] || e), (s[e] = t)), this
              );
            },
        ...
        if (
          (b.promise(S),
          (m.url = ((e || m.url || Ot.href) + "").replace(en, Ot.protocol + "//")),
          ...
          try {
            (a.href = m.url),
              (a.href = a.href),
              (m.crossDomain = an.protocol + "//" + an.host != a.protocol + "//" + a.host);
          } catch (T) {
            m.crossDomain = !0;
          }
        }
        if (
          ...
          return S;
        for (i in ((g = De.event && m.global) && 0 == De.active++ && De.event.trigger("ajaxStart"),
        ...
        m.hasContent
          ...
          : ((o = m.url.slice(f.length)),
            ...
            !1 === m.cache &&
              ((f = f.replace(Yt, "$1")), (o = (Wt.test(f) ? "&" : "?") + "_=" + qt.guid++ + o)),
            (m.url = f + o)),
        m.ifModified &&
          (De.lastModified[f] && S.setRequestHeader("If-Modified-Since", De.lastModified[f]),
        ...
        S.setRequestHeader(
          ...
          m.dataTypes[0] && m.accepts[m.dataTypes[0]]
            ? m.accepts[m.dataTypes[0]] + ("*" !== m.dataTypes[0] ? ", " + rn + "; q=0.01" : "")
            : m.accepts["*"]
        ),
        m.headers))
  ...
  De.ajaxSetup({
    ...
    De.ajaxPrefilter("json jsonp", function (e, t, n) {
      ...
      if (o || "jsonp" === e.dataTypes[0])
        return (
          (r = e.jsonpCallback = ye(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback),
          o
            ? (e[o] = e[o].replace(cn, "$1" + r))
            : !1 !== e.jsonp && (e.url += (Wt.test(e.url) ? "&" : "?") + e.jsonp + "=" + r),
    ...
    (De.parseHTML = function (e, t, n) {
      return "string" != typeof e
        ...
        : ("boolean" == typeof t && ((n = t), (t = !1)),
          t ||
            (ve.createHTMLDocument
              ? (((r = (t = xe.implementation.createHTMLDocument("")).createElement("base")).href =
                  xe.location.href),
          ...
          (a = Pe.exec(e))
            ? [t.createElement(a[1])]
            : ((a = S([e], t, i)), i && i.length && De(i).remove(), De.merge([], a.childNodes)));
      var r, a, i;
    }),
    (De.fn.load = function (e, t, n) {
      ...
      return (
        ...
        ye(t) ? ((n = t), (t = undefined)) : t && "object" == typeof t && (a = "POST"),
        0 < o.length &&
          De.ajax({ url: e, type: a || "GET", dataType: "html", data: t })
            .done(function (e) {
              (i = arguments), o.html(r ? De("<div>").append(De.parseHTML(e)).find(r) : e);
            })
            .always(
              n &&
                function (e, t) {
        ...
        if (this[0]) {
          ...
          if ("fixed" === De.css(r, "position")) t = r.getBoundingClientRect();
            ...
            for (
              ...
              e && (e === n.body || e === n.documentElement) && "static" === De.css(e, "position");
    ...
    De.each({ scrollLeft: "pageXOffset", scrollTop: "pageYOffset" }, function (t, a) {
      var i = "pageYOffset" === a;
      De.fn[t] = function (e) {
        return Ue(
          this,
          function (e, t, n) {
            var r;
            if ((be(e) ? (r = e) : 9 === e.nodeType && (r = e.defaultView), n === undefined))
              return r ? r[a] : e[t];
    ...
    De.each(["top", "left"], function (e, n) {
      De.cssHooks[n] = F(ve.pixelPosition, function (e, t) {
        if (t) return (t = R(e, n)), vt.test(t) ? De(e).position()[n] + "px" : t;
      });
    }),
    De.each({ Height: "height", Width: "width" }, function (o, s) {
      De.each({ padding: "inner" + o, content: s, "": "outer" + o }, function (r, i) {
  ...
  return (
    (De.noConflict = function (e) {
      return le.$ === De && (le.$ = hn), e && le.jQuery === De && (le.jQuery = dn), De;
    }),
...
var hljs = new (function () {
  ...
  function h(e, t) {
    for (var n = "", r = 0; r < e.childNodes.length; r++)
      if (3 == e.childNodes[r].nodeType) {
        ...
        t && (a = a.replace(/\n/g, "")), (n += a);
      } else "BR" == e.childNodes[r].nodeName ? (n += "\n") : (n += h(e.childNodes[r]));
    return /MSIE [678]/.test(navigator.userAgent) && (n = n.replace(/\r/g, "\n")), n;
  }
  function p(e) {
  ...
  function m(e, t, n) {
    ...
    function a(e) {
      for (var t = "<" + e.nodeName.toLowerCase(), n = 0; n < e.attributes.length; n++) {
    ...
    for (var i = 0, o = "", s = []; e.length || t.length; ) {
      ...
      if (((o += w(n.substr(i, l.offset - i))), (i = l.offset), "start" == l.event))
  ...
  function T(e, t) {
    ...
    function r(e, t) {
      ...
      for (var a = t.lR.exec(e); a; ) {
        ...
        var i = o(t, a);
        i
          ? ((g += i[1]), (n += '<span class="' + i[0] + '">' + w(a[0]) + "</span>"))
          : (n += w(a[0])),
          (r = t.lR.lastIndex),
          (a = t.lR.exec(e));
      }
    ...
    function i(e, t, n) {
      ...
      if (i) {
        ...
        var s = h[h.length - 1];
        return h.length--, (h[h.length - 1].buffer = ""), s.starts && d(s.starts, ""), r.rE;
      }
    ...
    try {
      ...
      if ("Illegal" == x) return { language: null, r: 0, keyword_count: 0, value: w(t) };
      throw x;
    }
  }
  function e() {
  ...
  function a(e, n, t) {
    ...
    if ("no-highlight" != a) {
        ...
        for (var s in D)
          if (D.hasOwnProperty(s)) {
            ...
            l.keyword_count + l.r > o.keyword_count + o.r && (o = l),
              l.keyword_count + l.r > i.keyword_count + i.r && ((o = i), (i = l));
          }
      }
      var u = e.className;
      ...
      var c = g(e);
      if (c.length)
        ((f = document.createElement("pre")).innerHTML = i.value), (i.value = m(c, g(f), r));
      if (
        (n &&
  ...
  function t() {
    ...
    window.addEventListener
      ? (window.addEventListener("DOMContentLoaded", t, !1), window.addEventListener("load", t, !1))
      : window.attachEvent
...
(hljs.LANGUAGES.ruby = (function () {
  ...
  (function (c, s, o) {
    ...
    function d(e, t) {
      return Math.round((/%/.test(e) ? ("x" === t ? j.width() : f()) / 100 : 1) * parseInt(e, 10));
    }
    function h(e, t) {
      ...
      (X = 0),
        e && !1 !== e && "nofollow" !== e
          ? ((N = c("." + ne).filter(function () {
            ...
            -1 === (X = N.index(W.el)) && ((N = N.add(W.el)), (X = N.length - 1)))
          : (N = c(W.el));
    }
    function y(e) {
      ...
      if (!Y) {
        if (((t = c(e).data(ee)), v((W = new u(e, t)).get("rel")), !G)) {
          (G = J = !0),
            ...
            (I = l(ce, "LoadedContent", "width:0; height:0; overflow:hidden; visibility:hidden")),
          ...
          (W.w = Math.max((!1 !== a ? Math.min(n, d(a, "x")) : n) - z - B, 0)),
            (W.h = Math.max((!1 !== i ? Math.min(r, d(i, "y")) : r) - U - $, 0)),
        ...
        w
          ...
          .show(),
          W.get("closeButton") ? O.html(W.get("close")).appendTo(D) : O.appendTo("<div/>"),
          x();
      }
    }
    function a() {
      S ||
        ...
        T.append(
          l(ce).append(l(ce, "TopLeft"), (C = l(ce, "TopCenter")), l(ce, "TopRight")),
          l(ce, !1, "clear:left").append((_ = l(ce, "MiddleLeft")), D, (A = l(ce, "MiddleRight"))),
    ...
    function x() {
      ...
      if (
        ...
        (W.mh = W.h),
        W.get("maxWidth") &&
          ((W.mw = d(W.get("maxWidth"), "x") - z - B), (W.mw = W.w && W.w < W.mw ? W.w : W.mw)),
        W.get("maxHeight") &&
          ((W.mh = d(W.get("maxHeight"), "y") - U - $), (W.mh = W.h && W.h < W.mh ? W.h : W.mh)),
        (e = W.get("href")),
        ...
        W.get("iframe")
                  ...
                  setTimeout(function () {
                    ...
                    W.get("retinaImage") &&
                      ...
                      W.get("scalePhotos") &&
                        ...
                        W.mw && V.width > W.mw && ((e = (V.width - W.mw) / V.width), t()),
                        W.mh && V.height > W.mh && ((e = (V.height - W.mh) / V.height), t())),
                      W.h && (V.style.marginTop = Math.max(W.mh - V.height, 0) / 2 + "px"),
                      N[1] &&
                        (W.get("loop") || N[X + 1]) &&
          ...
          : e &&
            L.load(e, W.get("data"), function (e, t) {
              a === fe &&
                r("error" === t ? l(ce, "Error").html(W.get("xhrError")) : c(this).contents());
            });
    }
    var w,
      S,
      ...
      he = (function () {
        ...
        function t() {
          (W.get("loop") || N[X + 1]) && (e(), (o = setTimeout(K.next, W.get("slideshowSpeed"))));
        }
        function n() {
        ...
        return function () {
          i
            ...
            : W.get("slideshow") &&
              N[1] &&
              ((i = !0), ue.one(oe, a), W.get("slideshowAuto") ? n() : r(), P.show());
        };
      })();
    c[ee] ||
      (c(a),
      ((K = c.fn[ee] = c[ee] = function (t, e) {
        var n = this;
        return (
          (t = t || {}),
        ...
        function n() {
          (C[0].style.width = k[0].style.width = D[0].style.width =
            parseInt(S[0].style.width, 10) - B + "px"),
            (D[0].style.height = _[0].style.height = A[0].style.height =
        ...
        if (
          ...
          !1 !== W.get("right")
            ? (s += Math.max(j.width() - W.w - z - B - d(W.get("right"), "x"), 0))
            : !1 !== W.get("left")
            ? (s += d(W.get("left"), "x"))
      ...
      (K.resize = function (e) {
        ...
        G &&
          ...
          e.innerHeight ||
            e.height ||
            ((t = I.scrollTop()), I.css({ height: "auto" }), (W.h = I.height())),
          I.css({ height: W.h }),
          t && I.scrollTop(t),
      ...
      (K.prep = function (e) {
        function t() {
          return (W.w = W.w || I.width()), (W.w = W.mw && W.mw < W.w ? W.mw : W.w), W.w;
        }
        function n() {
          return (W.h = W.h || I.height()), (W.h = W.mh && W.mh < W.h ? W.mh : W.h), W.h;
        }
        if (G) {
          var r,
          ...
          I.remove(),
            ...
            (r = function () {
              function e() {
                !1 === c.support.opacity && S[0].style.removeAttribute("filter");
              }
              var t,
                n,
                r = N.length;
              G &&
                ...
                1 < r
                  ? ("string" == typeof W.get("current") &&
                    ...
                    H[W.get("loop") || X < r - 1 ? "show" : "hide"]().html(W.get("next")),
                    M[W.get("loop") || X ? "show" : "hide"]().html(W.get("previous")),
                    he(),
                    W.get("preloading") &&
                      c.each([i(-1), i(1)], function () {
                        var e = N[this],
                          ...
                          n = t.get("href");
                        n && h(t, n) && ((n = p(t, n)), (s.createElement("img").src = n));
                      }))
                  : q.hide(),
                W.get("iframe")
  ...
  (function (n) {
    ...
    "function" == typeof define && define.amd
      ...
      ? (module.exports = function (e, t) {
          return (
            e || (e = window),
            t || (t = "undefined" != typeof window ? require("jquery") : require("jquery")(e)),
            n(t, e, e.document)
          );
        })
    ...
    function o(t) {
      ...
      $.each(t, function (e) {
        (n = e.match(/^([^A-Z]+?)([A-Z])/)) &&
          -1 !== a.indexOf(n[1] + " ") &&
          ((r = e.replace(n[0], n[2].toLowerCase())), (i[r] = e), "o" === n[1] && o(t[e]));
      }),
        (t._hungarianMap = i);
    }
    function A(t, n, r) {
      ...
      t._hungarianMap || o(t),
        $.each(n, function (e) {
          (a = t._hungarianMap[e]) === B ||
            (!r && n[a] !== B) ||
            ("o" === a.charAt(0)
              ? (n[a] || (n[a] = {}), $.extend(!0, n[a], n[e]), A(t[a], n[a], r))
              : (n[a] = n[e]));
        });
    }
    function N(e) {
    ...
    function j(e) {
      ...
      if (t) for (var n = 0, r = t.length; n < r; n++) t[n] && A(Ge.models.oSearch, t[n]);
    }
    function I(e) {
    ...
    function L(e) {
      if (!Ge.__browser) {
        ...
        (t.barWidth = r[0].offsetWidth - r[0].clientWidth),
          (t.bScrollOversize = 100 === a[0].offsetWidth && 100 !== r[0].clientWidth),
          (t.bScrollbarLeft = 1 !== Math.round(a.offset().left)),
          (t.bBounding = !!n[0].getBoundingClientRect().width),
          n.remove();
      }
      $.extend(e.oBrowser, Ge.__browser), (e.oScroll.iBarWidth = Ge.__browser.barWidth);
    }
    function n(e, t, n, r, a, i) {
      var o,
        ...
        l = !1;
      for (n !== B && ((o = n), (l = !0)); s !== a; )
        e.hasOwnProperty(s) && ((o = l ? t(o, e[s], s, e) : e[s]), (l = !0), (s += i));
      return o;
    }
    function E(e, t) {
    ...
    function R(e, t, n) {
      ...
      (r._bAttrSrc = $.isPlainObject(s) && (c(s.sort) || c(s.type) || c(s.filter))),
        (r._setter = null),
      ...
      r.bSortable && (f || d)
        ? f && !d
          ? ((r.sSortingClass = a.sSortableAsc), (r.sSortingClassJUI = a.sSortJUIAscAllowed))
          : !f && d
          ? ((r.sSortingClass = a.sSortableDesc), (r.sSortingClassJUI = a.sSortJUIDescAllowed))
        ...
        for (a = t.length - 1; 0 <= a; a--) {
          ...
          for ($.isArray(d) || (d = [d]), o = 0, s = d.length; o < s; o++)
            if ("number" == typeof d[o] && 0 <= d[o]) {
              ...
              r(d[o], c);
            } else if ("number" == typeof d[o] && d[o] < 0) r(f.length + d[o], c);
    ...
    function M(e, t, n, r) {
      ...
      var u = e.rowIdFn(t);
      return u !== B && (e.aIds[u] = i), (!n && e.oFeatures.bDeferRender) || S(e, a, n, r), a;
    }
    function O(n, e) {
      var r;
      return (
    ...
    function y(r) {
      ...
      var p = function (e, t, n) {
        for (
          var r, a, i, o, s, l = m(n), u = l[l.length - 1], c = 0, f = l.length - 1;
          c < f;
          c++
        ) {
          if (((a = l[c].match(gt)), (i = l[c].match(mt)), a)) {
            if (
              ...
              for (var d = 0, h = t.length; d < h; d++) p((o = {}), t[d], s), e[l[c]].push(o);
            else e[l[c]] = t;
            return;
          }
        ...
        u.match(mt) ? (e = e[u.replace(mt, "")](t)) : (e[u.replace(gt, "")] = t);
      };
      return function (e, t) {
        return p(e, t, r);
      };
    ...
    function h(e, t, n) {
      for (var r = -1, a = 0, i = e.length; a < i; a++) e[a] == t ? (r = a) : e[a] > t && e[a]--;
    ...
    function f(e, t, n, a) {
      ...
      var d = function (e, t) {
        ...
        h = function (e) {
          (n !== B && n !== u) ||
            ...
            (o = $.trim(e.innerHTML)),
            i && i._bAttrSrc
              ? (y(i.mData._)(a, o), d(i.mData.sort, e), d(i.mData.type, e), d(i.mData.filter, e))
              : f
      ...
      if (l)
        for (; l; )
          ("TD" != (r = l.nodeName.toUpperCase()) && "TH" != r) || (h(l), s.push(l)),
            (l = l.nextSibling);
    ...
    function S(e, t, n, r) {
      ...
      if (null === c.nTr) {
        for (
          ...
          (o = e.aoColumns[s]),
            ((i = (u = !n) ? x.createElement(o.sCellType) : r[s])._DT_CellIndex = {
              row: t,
              column: s,
            }),
            d.push(i),
            ...
            o.bVisible && !n ? a.appendChild(i) : !o.bVisible && n && i.parentNode.removeChild(i),
            o.fnCreatedCell && o.fnCreatedCell.call(e.oInstance, i, g(e, t, s), f, t, s);
    ...
    function p(e, t) {
      ...
      if (n) {
        ...
        r.DT_RowAttr && $(n).attr(r.DT_RowAttr), r.DT_RowData && $(n).data(r.DT_RowData);
      }
    }
    function d(e) {
      var t,
      ...
      for (l && (a = $("<tr/>").appendTo(o)), t = 0, n = c.length; t < n; t++)
        (i = c[t]),
          ...
          e.oFeatures.bSort &&
            ...
            !1 !== i.bSortable &&
              (r.attr("tabindex", e.iTabIndex).attr("aria-controls", e.sTableId), _e(e, i.nTh, t))),
    ...
    function b(e) {
      ...
      if (-1 === $.inArray(!1, t)) {
        ...
        if (0 !== u.length)
          for (var d = l ? 0 : c, h = l ? e.aoData.length : f, p = d; p < h; p++) {
            ...
            if (0 !== i) {
              var y = a[r % i];
              m._sRowStripe != y &&
                ($(v).removeClass(m._sRowStripe).addClass(y), (m._sRowStripe = y));
            }
            He(e, "aoRowCallback", null, [v, m._aData, r, p, g]), n.push(v), r++;
          }
        else {
        ...
        He(e, "aoHeaderCallback", "header", [$(e.nTHead).children("tr")[0], w(e), c, f, u]),
          He(e, "aoFooterCallback", "footer", [$(e.nTFoot).children("tr")[0], w(e), c, f, u]);
        var x = $(e.nTBody);
        x.children().detach(),
          x.append($(n)),
    ...
    function D(e) {
      ...
      for (var o, s, l, u, c, f, d = e.sDom.split(""), h = 0; h < d.length; h++) {
        if (((o = null), "<" == (s = d[h]))) {
          if (((l = $("<div/>")[0]), "'" == (u = d[h + 1]) || '"' == u)) {
            for (c = "", f = 2; d[h + f] != u; ) (c += d[h + f]), f++;
            if (
              ("H" == c ? (c = t.sJUIHeader) : "F" == c && (c = t.sJUIFooter), -1 != c.indexOf("."))
            ) {
              var p = c.split(".");
      ...
      for (a = 0, s = h.length; a < s; a++)
        for (u = 0, r = (n = h[a]).firstChild; r; ) {
          if ("TD" == r.nodeName.toUpperCase() || "TH" == r.nodeName.toUpperCase())
            for (
              c = (c = 1 * r.getAttribute("colspan")) && 0 !== c && 1 !== c ? c : 1,
    ...
    function C(r, e, t) {
      ...
      if ($.isPlainObject(o) && o.data) {
        ...
        (e = "function" == typeof n && u ? u : $.extend(!0, e, u)), delete o.data;
      }
      var c = {
        data: e,
        success: function (e) {
    ...
    function s(e, n) {
      ...
      u(e), (e._iRecordsTotal = parseInt(i, 10)), (e._iRecordsDisplay = parseInt(o, 10));
    ...
    function V(e, t) {
      var n = $.isPlainObject(e.ajax) && e.ajax.dataSrc !== B ? e.ajax.dataSrc : e.sAjaxDataProp;
    ...
    function Y(e) {
      for (var t, n, r = Ge.ext.search, a = e.aiDisplay, i = 0, o = r.length; i < o; i++) {
        for (var s = [], l = 0, u = a.length; l < u; l++)
          (n = a[l]), (t = e.aoData[n]), r[i](e, t._aFilterData, n, t._aData, l) && s.push(n);
        (a.length = 0), $.merge(a, s);
      }
    }
    function Z(e, t, n, r, a, i) {
      if ("" !== t) {
        for (var o, s = [], l = e.aiDisplay, u = Q(t, r, a, i), c = 0; c < l.length; c++)
    ...
    function K(e, t, n, r, a, i) {
      ...
      if ((0 !== Ge.ext.search.length && (n = !0), (s = ee(e)), t.length <= 0))
        ...
        for (
          (s || n || r || c.length > t.length || 0 !== t.indexOf(c) || e.bSorted) &&
            (e.aiDisplay = f.slice()),
            o = e.aiDisplay,
            l = 0;
          l < o.length;
    ...
    function ae(e) {
      ...
      if (0 !== t.length) {
        ...
        o !== i && (s += " " + n.sInfoFiltered), (s = ie(e, (s += n.sInfoPostFix)));
    ...
    function ue(r) {
      for (
        ...
        s[0][l] = new Option("number" == typeof o[l] ? r.fnFormatNumber(o[l]) : o[l], i[l]);
            ...
            fn: function (e) {
              if (f) {
                var t,
                  ...
                  l = o ? 1 : Math.ceil(i / a),
                  u = c(s, l);
                for (t = 0, n = h.p.length; t < n; t++) Oe(e, "pageButton")(e, h.p[t], t, u, s, l);
              } else c.fnUpdate(e, d);
            },
            sName: "pagination",
          })),
    ...
    function fe(e, t, n) {
      ...
      return (e._iDisplayStart = r), o && (He(e, null, "page", [e]), n && b(e)), o;
    }
    function de(e) {
      return $("<div/>", {
    ...
    function ge(n) {
      ...
      if (n.scrollBarVis !== M && n.scrollBarVis !== B) return (n.scrollBarVis = M), void U(n);
      (n.scrollBarVis = M),
        _.children("thead, tfoot").remove(),
        N && ((o = N.clone().prependTo(_)), (t = N.find("tr")), (a = o.find("tr"))),
        ...
        "" === f
          ? ((k.width = "100%"),
            I &&
              (_.find("tbody").height() > x.offsetHeight || "scroll" == w.css("overflow-y")) &&
        ...
        _.outerWidth() < u
          ? ((l = x.scrollHeight > x.offsetHeight || "scroll" == w.css("overflow-y") ? u + p : u),
            I &&
              (x.scrollHeight > x.offsetHeight || "scroll" == w.css("overflow-y")) &&
              (k.width = we(l - p)),
            ("" !== f && "" === d) || Le(n, 1, "Possible column misalignment", 6))
          : (l = "100%"),
        (S.width = we(l)),
        (m.width = we(l)),
    ...
    function ve(e) {
      ...
      for (y && -1 !== y.indexOf("%") && (h = y), t = 0; t < f.length; t++)
        null !== (n = i[f[t]]).sWidth && ((n.sWidth = ye(n.sWidthOrig, p)), (g = !0));
      if (v || (!g && !l && !s && c == F(e) && c == d.length))
        ...
        for (
          ...
          (n = i[f[t]]),
            (d[t].style.width =
              null !== n.sWidthOrig && "" !== n.sWidthOrig ? we(n.sWidthOrig) : ""),
            n.sWidthOrig &&
              l &&
              $(d[t]).append(
                $("<div/>").css({
        ...
        if (e.aoData.length)
          for (t = 0; t < f.length; t++)
            (n = i[(r = f[t])]), $(be(e, r)).clone(!1).append(n.sContentPadding).appendTo(w);
        ...
        for (t = 0; t < f.length; t++) {
          var D = $(d[t]),
            ...
            _ = m.bBounding ? Math.ceil(d[t].getBoundingClientRect().width) : D.outerWidth();
    ...
    function xe(e, t) {
      for (var n, r = -1, a = -1, i = 0, o = e.aoData.length; i < o; i++)
        (n = (n = (n = g(e, i, t, "display") + "").replace(xt, "")).replace(/&nbsp;/g, " "))
        ...
        i === c.length
          ? o.sort(function (e, t) {
              var n,
                ...
                u = h[t]._aSortData;
              for (a = 0; a < s; a++)
                if (0 !== (i = (n = l[(o = c[a]).col]) < (r = u[o.col]) ? -1 : r < n ? 1 : 0))
          ...
          : o.sort(function (e, t) {
              ...
              for (a = 0; a < s; a++)
                if (
                  ((n = l[(o = c[a]).col]),
                  (r = u[o.col]),
                  0 !== (i = (d[o.type + "-" + o.dir] || d["string-" + o.dir])(n, r)))
                )
                  return i;
              return (n = f[e]) < (r = f[t]) ? -1 : r < n ? 1 : 0;
            });
    ...
    function De(e) {
      for (
        var t, n, r = e.aoColumns, a = Se(e), i = e.oLanguage.oAria, o = 0, s = r.length;
        o < s;
        o++
      ) {
        var l = r[o],
        ...
        f.removeAttribute("aria-sort"),
          l.bSortable
            ? (0 < a.length && a[0].col == o
                ? (f.setAttribute("aria-sort", "asc" == a[0].dir ? "ascending" : "descending"),
                  (n = u[a[0].index + 1] || u[0]))
                : (n = u[0]),
    ...
    function Ce(e, t, n, r) {
      var a,
        ...
        l = function (e, t) {
          var n = e._idx;
          return n === B && (n = $.inArray(e[1], s)), n + 1 < s.length ? n + 1 : t ? null : 0;
        };
    ...
    function Ae(e) {
      ...
      if (s.bSort && s.bSortClasses) {
        for (t = 0, n = a.length; t < n; t++)
          (r = a[t].src), $(st(e.aoData, "anCells", r)).removeClass(i + (t < 2 ? t + 1 : 3));
        for (t = 0, n = o.length; t < n; t++)
          (r = o[t].src), $(st(e.aoData, "anCells", r)).addClass(i + (t < 2 ? t + 1 : 3));
      }
      e.aLastSort = o;
    }
    function ke(e, t) {
      ...
      for (var s = Ge.ext.type.order[i.sType + "-pre"], l = 0, u = e.aoData.length; l < u; l++)
        (r = e.aoData[l])._aSortData || (r._aSortData = []),
          (r._aSortData[t] && !o) ||
            ((a = o ? n[l] : g(e, l, t, "sort")), (r._aSortData[t] = s ? s(a) : a));
    }
    function Ne(n) {
            ...
            if (-1 === $.inArray(!1, t)) {
              ...
              if (0 < n && e.time < +new Date() - 1e3 * n) i();
                ...
                if (
                  ...
                  e.start !== B && ((a._iDisplayStart = e.start), (a.iInitDisplayStart = e.start)),
                  ...
                  for (o = 0, s = e.columns.length; o < s; o++) {
                    ...
                    r.visible !== B && (l[o].bVisible = r.visible),
                      r.search !== B && $.extend(a.aoPreSearchCols[o], ne(r.search));
                  }
    ...
    function Le(e, t, n, r) {
      if (
        ...
        r &&
          (n +=
            ". For more information about this error, please see http://datatables.net/tn/" + r),
        t)
      )
    ...
    function Oe(e, t) {
      var n = e.renderer,
        r = Ge.ext.renderer[t];
      return $.isPlainObject(n) && n[t] ? r[n[t]] || r._ : ("string" == typeof n && r[n]) || r._;
    }
    function qe(e) {
    ...
    function Be(t) {
      return function () {
        var e = [Ie(this[Ge.ext.iApiIndex])].concat(Array.prototype.slice.call(arguments));
    ...
    var Ue,
      ...
      Ge = function (T) {
        (this.$ = function (e, t) {
          ...
          (this.fnDeleteRow = function (e, t, n) {
            var r = this.api(!0),
              ...
              i = a.settings()[0],
              o = i.aoData[a[0][0]];
            return a.remove(), t && t.call(this, i, o), (n === B || n) && r.draw(), o;
          }),
          ...
          (this.fnFilter = function (e, t, n, r, a, i) {
            var o = this.api(!0);
            null === t || t === B ? o.search(e, n, r, i) : o.column(t).search(e, n, r, i), o.draw();
          }),
          ...
          (this.fnGetNodes = function (e) {
            var t = this.api(!0);
            return e !== B ? t.row(e).node() : t.rows().nodes().flatten().toArray();
          }),
        ...
        var D = this,
          C = T === B,
          _ = this.length;
        for (var e in (C && (T = {}), (this.oApi = this.internal = Ue.internal), Ge.ext.internal))
          e && (this[e] = Be(e));
        return (
          this.each(function () {
            var i,
            ...
            if ("table" == this.nodeName.toLowerCase()) {
              ...
              if (
                ...
                f.iInitDisplayStart === B &&
                  ((f.iInitDisplayStart = o.iDisplayStart), (f._iDisplayStart = o.iDisplayStart)),
              ...
              $.extend(!0, p, o.oLanguage),
                p.sUrl &&
                  ...
                  (l = !0)),
                null === o.asStripeClasses && (f.asStripeClasses = [d.sStripeOdd, d.sStripeEven]);
              ...
              -1 !==
                ...
                ($("tbody tr", this).removeClass(g.join(" ")), (f.asDestroyStripes = g.slice()));
              var v,
                y = [],
                b = this.getElementsByTagName("thead");
              if ((0 !== b.length && (W(f.aoHeader, b[0]), (y = X(f))), null === o.aoColumns))
              ...
              var w = f.oFeatures,
                S = function () {
                  if (o.aaSorting === B) {
                    var e = f.aaSorting;
                    for (s = 0, i = e.length; s < i; s++) e[s][1] = f.aoColumns[s].asSorting[0];
                  }
                  Ae(f),
                    w.bSort &&
                    ...
                    Pe(
                      ...
                      "aoDrawCallback",
                      function () {
                        (f.bSorted || "ssp" === qe(f) || w.bDeferRender) && Ae(f);
                      },
                      "sc"
                    );
                  var t = u.children("caption").each(function () {
                    ...
                    n = u.children("thead");
                  0 === n.length && (n = $("<thead/>").appendTo(u)), (f.nTHead = n[0]);
                  var r = u.children("tbody");
                  0 === r.length && (r = $("<tbody/>").appendTo(u)), (f.nTBody = r[0]);
                  ...
                  if (
                    ...
                    0 === a.length || 0 === a.children().length
                      ...
                      : 0 < a.length && ((f.nTFoot = a[0]), W(f.aoFooter, f.nTFoot)),
                    o.aaData)
                  )
                    for (s = 0; s < o.aaData.length; s++) M(f, o.aaData[s]);
                  else (f.bDeferLoading || "dom" == qe(f)) && O(f, $(f.nTBody).children("tr"));
                  (f.aiDisplay = f.aiDisplayMaster.slice()), !(f.bInitialised = !0) === l && oe(f);
                };
              o.bStateSave
                ? ((w.bStateSave = !0), Pe(f, "aoDrawCallback", Ne, "state_save"), je(f, o, S))
                : S();
      ...
      rt = function (e, t) {
        return (
          ...
          "string" == typeof e && "." !== t ? e.replace(/\./g, "").replace(Je[t], ".") : e
        );
      },
      at = function (e, t, n) {
    ...
    (ze = function (e, t) {
      ...
      $.extend(ze.prototype, {
        ...
        iterator: function (e, t, n, r) {
          var a,
            ...
            p = this.selector;
          for (
            "string" == typeof e && ((r = n), (n = t), (t = e), (e = !1)), i = 0, o = h.length;
            i < o;
            i++
          ) {
            var g = new ze(h[i]);
            if ("table" === t) (a = n.call(g, h[i], i)) !== B && d.push(a);
              ...
              for (
                c = this[i], "column-rows" === t && (u = jt(h[i], p.opts)), s = 0, l = c.length;
                s < l;
                s++
              )
                (f = c[s]),
      ...
      (ze.extend = function (e, t, n) {
        if (n.length && t && (t instanceof ze || t.__dt_wrapper)) {
          ...
          for (r = 0, a = n.length; r < a; r++)
            (t[(i = n[r]).name] =
              "function" === i.type ? o(e, i.val, i) : "object" === i.type ? {} : i.val),
              (t[i.name].__dt_wrapper = !0),
              ze.extend(e, t[i.name], i.propExt);
        }
      }),
      (ze.register = Xe = function (e, t) {
        if ($.isArray(e)) for (var n = 0, r = e.length; n < r; n++) ze.register(e[n], t);
        else {
          var a,
            i,
            o,
          ...
          for (a = 0, i = l.length; a < i; a++) {
            var f = c(u, (o = (s = -1 !== l[a].indexOf("()")) ? l[a].replace("()", "") : l[a]));
            f ||
              ((f = {
                name: o,
                val: {},
      ...
      (ze.registerPlural = Ve = function (e, t, n) {
        ze.register(e, n),
    ...
    Xe("tables()", function (e) {
      ...
      Xe("draw()", function (t) {
        return this.iterator("table", function (e) {
          "page" === t ? b(e) : ("string" == typeof t && (t = "full-hold" !== t), T(e, !1 === t));
        });
      }),
      Xe("page()", function (t) {
        return t === B
    ...
    var At = function (e, t, n, r, a) {
        var i,
          ...
          d = typeof t;
        for (
          (t && "string" !== d && "function" !== d && t.length !== B) || (t = [t]),
            s = 0,
            l = t.length;
          s < l;
          s++
          ...
          for (
            u = 0,
              c = (o = t[s] && t[s].split && !t[s].match(/[\[\(:]/) ? t[s].split(",") : [t[s]])
                .length;
            u < c;
            u++
          )
            (i = n("string" == typeof o[u] ? $.trim(o[u]) : o[u])) && i.length && (f = f.concat(i));
        var h = Ue.selector[e];
      ...
      Nt = function (e) {
        for (var t = 0, n = e.length; t < n; t++)
          if (0 < e[t].length)
            return (
              (e[0] = e[t]), (e[0].length = 1), (e.length = 1), (e.context = [e.context[t]]), e
            );
        return (e.length = 0), e;
      },
      jt = function (e, t) {
        ...
        if ("current" == l)
          for (c = e._iDisplayStart, f = e.fnDisplayEnd(); c < f; c++) r.push(a[c]);
          ...
          for (c = 0, f = e.aoData.length; c < f; c++)
            "none" == o
              ? r.push(c)
              : ((-1 === (n = $.inArray(c, a)) && "removed" == o) || (0 <= n && "applied" == o)) &&
                r.push(c);
        return r;
      },
      It = function (l, e, u) {
        ...
        return At(
          ...
          function (n) {
            ...
            if ((c || (c = jt(l, u)), null !== e && -1 !== $.inArray(e, c))) return [e];
            ...
            if (n.nodeName) {
              ...
              if (a) return r[a.row] && r[a.row].nTr === n.parentNode ? [a.row] : [];
    ...
    Xe("rows()", function (t, n) {
      t === B ? (t = "") : $.isPlainObject(t) && ((n = t), (t = "")), (n = kt(n));
      var e = this.iterator(
        "table",
        function (e) {
          return It(e, t, n);
      ...
      Xe("row().data()", function (e) {
        var t = this.context;
        if (e === B) return t.length && this.length ? t[0].aoData[this[0]]._aData : B;
      ...
      Xe("row.add()", function (t) {
        ...
        var e = this.iterator("table", function (e) {
          return t.nodeName && "TR" === t.nodeName.toUpperCase() ? O(e, t)[0] : M(e, t);
        });
        return this.row(e[0]);
      });
    var Lt = function (i, e, t, n) {
      ...
      Et = function (e, t) {
        ...
        if (n.length) {
          ...
          r && r._details && (r._details.remove(), (r._detailsShow = B), (r._details = B));
        }
      },
      Rt = function (e, t) {
        var n = e.context;
        if (n.length && e.length) {
          ...
          r._details &&
            ((r._detailsShow = t) ? r._details.insertAfter(r.nTr) : r._details.detach(), Ft(n[0]));
        }
      },
      Ft = function (o) {
        var a = new ze(o),
            ...
            a.on(n, function (e, t) {
              if (o === t)
                for (var n, r = F(t), a = 0, i = s.length; a < i; a++)
                  (n = s[a])._details && n._details.children("td[colspan]").attr("colspan", r);
            }),
            a.on(r, function (e, t) {
              if (o === t) for (var n = 0, r = s.length; n < r; n++) s[n]._details && Et(a, n);
            }));
      },
      Pt = "" + "row().child",
      Ht = Pt + "()";
        ...
        if (l.bVisible !== n) {
          if (n) {
            ...
            for (a = 0, i = u.length; a < i; a++)
              (o = u[a].nTr), (r = u[a].anCells), o && o.insertBefore(r[t], r[c] || null);
    ...
    Xe("columns()", function (t, n) {
      ...
      Ve("columns().cache()", "column().cache()", function (i) {
        return this.iterator(
          "column-rows",
          function (e, t, n, r, a) {
            return lt(e.aoData, a, "search" === i ? "_aFilterData" : "_aSortData", t);
          },
          1
        );
      }),
        ...
        return (
          n !== B &&
            this.iterator("table", function (e) {
              v(e, e.aoHeader),
                v(e, e.aoFooter),
                e.aiDisplay.length || $(e.nTBody).find("td[colspan]").attr("colspan", F(e)),
                Ne(e),
          ...
          if (null === e || e === B || t) {
            for (i = [], o = 0, s = d.length; o < s; o++)
              for (a = d[o], l = 0; l < p; l++)
                (u = { row: a, column: l }),
                  t
                    ? ((c = f[a]), e(u, g(r, a, l), c.anCells ? c.anCells[l] : null) && i.push(u))
                    : i.push(u);
            return i;
          }
          if ($.isPlainObject(e))
            return e.column !== B && e.row !== B && -1 !== $.inArray(e.row, d) ? [e] : [];
          var n = h
            .filter(e)
            .map(function (e, t) {
              return {
    ...
    Xe("cells()", function (t, e, n) {
      if (
        ($.isPlainObject(t) && (t.row === B ? ((n = t), (t = null)) : ((n = e), (e = null))),
        ...
        c = this.iterator(
          ...
          function (e, t) {
            ...
            for (r = 0, a = u[t].length; r < a; r++)
              for (i = 0, o = l[t].length; i < o; i++) n.push({ row: u[t][r], column: l[t][i] });
            return n;
          },
          1
        ),
      ...
      Xe("cell().data()", function (e) {
        ...
        return e === B
          ? t.length && n.length
            ...
            : B
          : (r(t[0], n[0].row, n[0].column, e), a(t[0], n[0].row, "data", n[0].column), this);
      }),
      Xe("order()", function (t, e) {
        ...
        return t === B
          ...
          : ("number" == typeof t
              ? (t = [[t, e]])
              : t.length && !$.isArray(t[0]) && (t = Array.prototype.slice.call(arguments)),
            this.iterator("table", function (e) {
              e.aaSorting = t.slice();
            }));
      }),
      ...
      (Ge.versionCheck = Ge.fnVersionCheck = function (e) {
        for (var t, n, r = Ge.version.split("."), a = e.split("."), i = 0, o = a.length; i < o; i++)
          if ((t = parseInt(r[i], 10) || 0) !== (n = parseInt(a[i], 10) || 0)) return n < t;
        return !0;
      }),
      (Ge.isDataTable = Ge.fnIsDataTable = function (e) {
        var a = $(e).get(0),
          i = !1;
        return (
          e instanceof Ge.Api ||
        ...
        return (
          ...
          this.iterator("table", function (t) {
            ...
            (t.bDestroying = !0),
              ...
              s && a != s.parentNode && (l.children("tfoot").detach(), l.append(s)),
              (t.aaSorting = []),
              (t.aaSortingFixed = []),
              Ae(t),
      ...
      $.each(["column", "row", "cell"], function (e, l) {
        Xe(l + "s().every()", function (i) {
          ...
          return this.iterator(l, function (e, t, n, r, a) {
            i.call(s[l](t, "cell" === l ? n : o, "cell" === l ? o : B), t, n, r, a);
          });
        });
      }),
    ...
    $.extend(Bt, {
                  ...
                  if (((a = t[n]), $.isArray(a))) {
                    ...
                    switch (((h = null), (p = a), (i = u.iTabIndex), a)) {
                      ...
                      case "first":
                        ...
                        break;
                      case "previous":
                        (h = m.sPrevious), 0 === f && ((i = -1), (p += " " + o));
                        break;
                      case "next":
                        (h = m.sNext), f === d - 1 && ((i = -1), (p += " " + o));
                        break;
                      case "last":
                        (h = m.sLast), f === d - 1 && ((i = -1), (p += " " + o));
                        break;
                      default:
      ...
      $.extend(Ge.ext.type.detect, [
        ...
        function (e) {
          return tt(e) || ("string" == typeof e && -1 !== e.indexOf("<")) ? "html" : null;
        },
      ]),
      $.extend(Ge.ext.type.search, {
        html: function (e) {
          return tt(e) ? e : "string" == typeof e ? e.replace(Ye, " ").replace(Ze, "") : "";
        },
        string: function (e) {
    ...
    var Ut = function (e, t, n, r) {
      return 0 === e || (e && "-" !== e)
        ? (t && (e = rt(e, t)),
          e.replace && (n && (e = e.replace(n, "")), r && (e = e.replace(r, ""))),
          1 * e)
        : -Infinity;
    };
    $.extend(Ue.type.order, {
      ...
      "html-pre": function (e) {
        return tt(e) ? "" : e.replace ? e.replace(/<.*?>/g, "").toLowerCase() : e + "";
      },
      "string-pre": function (e) {
        return tt(e) ? "" : "string" == typeof e ? e.toLowerCase() : e.toString ? e.toString() : "";
      },
        ...
        header: {
          _: function (i, o, s, l) {
            $(i.nTable).on("order.dt.DT", function (e, t, n, r) {
              if (i === t) {
                var a = s.idx;
                o.removeClass(s.sSortingClass + " " + l.sSortAsc + " " + l.sSortDesc).addClass(
                  "asc" == r[a] ? l.sSortAsc : "desc" == r[a] ? l.sSortDesc : s.sSortingClass
                );
              }
            });
          },
          jqueryui: function (i, o, s, l) {
            $("<div/>")
              ...
              .append(o.contents())
              .append($("<span/>").addClass(l.sSortIcon + " " + s.sSortingClassJUI))
              .appendTo(o),
              $(i.nTable).on("order.dt.DT", function (e, t, n, r) {
                if (i === t) {
                  var a = s.idx;
        ...
        number: function (i, o, s, l, u) {
          return {
            display: function (e) {
              ...
              return (
                t + (l || "") + r.toString().replace(/\B(?=(\d{3})+(?!\d))/g, i) + a + (u || "")
              );
            },
          };
        },
  ...
  (function (e) {
      ...
      return (
        isNaN(t.datetime) ||
          (0 === e.cutoff || Math.abs(i(t.datetime)) < e.cutoff
            ...
            : 0 < d(this).attr("title").length && d(this).text(d(this).attr("title"))),
        this
      );
    }
    function r(e) {
      if (!(e = d(e)).data("timeago")) {
        ...
        o.settings.localeTitle
          ...
          : !(0 < t.length) || (o.isTime(e) && e.attr("title")) || e.attr("title", t);
      }
    ...
    d.extend(d.timeago, {
      ...
      inWords: function (a) {
        ...
        var i = this.settings.strings,
          ...
          n = i.suffixAgo;
        if (
          (this.settings.allowFuture && a < 0 && ((t = i.prefixFromNow), (n = i.suffixFromNow)),
        ...
        var r = Math.abs(a) / 1e3,
          ...
          f = i.wordSeparator || "";
        return i.wordSeparator === undefined && (f = " "), d.trim([t, c, n].join(f));
      },
      parse: function (e) {
        var t = d.trim(e);
        return (
          (t = (t = (t = (t = (t = t.replace(/\.\d+/, "")).replace(/-/, "/").replace(/-/, "/"))
            .replace(/T/, " ")
            .replace(/Z/, " UTC")).replace(/([\+\-]\d\d)\:?(\d\d)/, " $1$2")).replace(
            /([\+\-]\d\d)$/,
            " $100"
          )),
          new Date(t)
    ...
    var s = {
      ...
      updateFromDOM: function () {
        d(this).data("timeago", {
          datetime: o.parse(o.isTime(this) ? d(this).attr("datetime") : d(this).attr("title")),
        }),
          n.apply(this);
      },
      dispose: function () {
        this._timeagoInterval &&
          (window.clearInterval(this._timeagoInterval), (this._timeagoInterval = null));
      },
    };
  ...
  $(document).ready(function () {
    ...
    $(".file_list").dataTable({ order: [[1, "asc"]], paging: !1 }),
      ...
      $(".source_table li[data-linenumber]").click(function () {
        ...
        return window.location.replace(window.location.href.replace(/#.*/, "#" + e)), (r = e), !1;
      }),
          ...
          $('a.src_link[href="#' + t + '"]').colorbox({ open: !0 }),
            n !== undefined &&
              $("#cboxLoadedContent").scrollTop(
                $('#cboxLoadedContent .source_table li[data-linenumber="' + n + '"]')[0].offsetTop
              );
        }
      }),
      $(".source_files").hide(),
      ...
      $(".file_list_container h2").each(function () {
        ...
        $(".group_tabs").append('<li><a href="#' + e + '">' + t + " (" + n + ")</a></li>");
      }),
      ...
      ($(".group_tabs").on("click", "a", function () {
        return (
          $(this).parent().hasClass("active") ||
            ...
            $("head").append('<link rel="icon" type="image/png" href="' + e + '" />')),
          !1
        );
      }),
